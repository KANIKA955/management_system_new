    ...
    <ActionSection>
        ...
        <template #content>
            ...
            <div class="flex items-center mt-5">
                <PrimaryButton @click="confirmLogout" class="text-sm px-4 py-1 rounded-sm font-semibold bg-gradient-to-r hover:bg-gradient-to-b from-primary to-primary/70 dark:from-info/50 dark:to-info/80 text-white hover:scale-105 transition ease-in duration-2000">
            ...
            <DialogModal :show="confirmingLogout" @close="closeModal">
                ...
                <template #footer>
                    ...
                    <PrimaryButton
                        class="ms-3 text-sm px-4 py-1 rounded-sm font-semibold bg-gradient-to-r hover:bg-gradient-to-b from-primary to-primary/70 dark:from-info/50 dark:to-info/80 text-white hover:scale-105 transition ease-in duration-2000"
